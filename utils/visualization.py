...
class BBoxVisualization():
    ...
    def draw_bboxes(self, img, boxes, confs, clss):
        ...
        for bb, cf, cl in zip(boxes, confs, clss):
            ...
            # filtro de pessoa, retirar futuramente (if)
            if cls_name == 'person': # **
              ...
              newBoxes.append([bb[0], bb[1], bb[2], bb[3]])
        #no return normalmente retornaria all_cls_name
        return img, all_cls_name, newBoxes
